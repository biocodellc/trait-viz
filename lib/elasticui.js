    ...
    (function (controllers) {
		...
		// can i add multiple queries
            ...
            IndexController.prototype.onResult = function (body, updateOnlyIfCountChanged) {
                ...
                if (!updateOnlyIfCountChanged || this.indexVM.results == null || this.indexVM.results.hits.total.value != body.hits.total) {
                    this.indexVM.results = body;
                    this.indexVM.pageCount = Math.ceil(this.indexVM.results.hits.total.value / this.indexVM.pageSize);
                }
